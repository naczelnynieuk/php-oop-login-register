...
<form action="register.php" method="post">
	<label for="">username <input type="text" name="username" value="<?php escape($form['username']); ?>"></label><br>
	...
	<label for="">email <input type="text" name="email" value="<?php  escape($form['email']); ?>"></label><br>
